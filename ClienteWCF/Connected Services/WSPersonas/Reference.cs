...
namespace ClienteWCF.WSPersonas {
    ...
    public partial class Persona : ClienteWCF.WSPersonas.BaseRespuesta {
        ...
        public string Secreto {
            get {
                return this.SecretoField;
            }
            set {
                if ((object.ReferenceEquals(this.SecretoField, value) != true)) {
                    this.SecretoField = value;
                    this.RaisePropertyChanged("Secreto");
                }
            }
        }
    }
